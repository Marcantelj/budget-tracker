# Personal Budget & Expense Management Engine

A financial calculation application built around a complex relational dictionary data model. This project demonstrates advanced system design, logical scale, and algorithmic arithmetic inside a decoupled ecosystem.

## 🛠️ Tech Stack & Key Concepts
* **Relational Object Mapping (Dictionaries)**
* **Algorithmic Data Aggregation (Running Tallies)**
* **Advanced Flexbox Structural Alignment**
* **Pseudo-Class Targeting (`:last-child`)**

## 🧠 Core Software Principles Learned
